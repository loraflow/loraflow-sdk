...
namespace lang {
    ...
    //
    //adapted from semtech packet_forward repositary
    //

#define code_62  '+'    /* RFC 1421 standard character for code 62 */
#define code_63  '/'    /* RFC 1421 standard character for code 63 */
#define code_pad  '='    /* RFC 1421 padding character if padding */
    ...
    namespace base64 {
        ...
        char code_to_char(uint8_t x) {
            if (x <= 25) {
                ...
                throw ("ERROR: OUT OF RANGE 0-63 FOR BASE64 ENCODING");
                //exit(EXIT_FAILURE);
        ...
        */
        ...
        uint8_t char_to_code(char x) {
            if ((x >= 'A') && (x <= 'Z')) {
                ...
                throw ("ERROR: INVALID CHARACTER FOR BASE64 DECODING");
                //exit(EXIT_FAILURE);
            } //TODO: improve error management
        }
        ...
        int bin_to_b64_nopad(const uint8_t * in, int size, char * out, int max_len) {
            ...
            switch (last_bytes) {
                ...
                case 2: /* 2 bytes left to encode -> +3 chars */
                    ...
                    break;
                default:
                    throw ("switch default that should not be possible");
            }
